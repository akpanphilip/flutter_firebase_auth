...
import 'package:flutter_firebase_auth/src/features/authentication/controllers/signup_controller.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(SignUpController()); //to access the controller
